...
{
    private static string AppTitle = "EGAH.EventHandler";
    ...
    public static void UseAppSwagger(this WebApplication app)
    {
        ...
        {
            options.RouteTemplate = "EventHandler/{documentname}/EventHandler.yaml";
        });

        app.UseSwaggerUI(
            options =>
            {
                options.RoutePrefix = "EventHandler";
                provider.ApiVersionDescriptions.ToList().ForEach(
                    description => options.SwaggerEndpoint($"/EventHandler/{description.GroupName}/EventHandler.yaml", description.GroupName.ToUpperInvariant())
                );
